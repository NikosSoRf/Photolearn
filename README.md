# Photolearn
проект реализации веб-приложения для обучения искусству фотографии (система курсов). Созданы основные взаимодействия между сервером и клиентом, проработана логика работы преподавателя и ученика с регистрацией, заданиями и записью на курс.
